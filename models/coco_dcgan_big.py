...
class Generator(nn.Module):
    ...
    def _init_modules(self):
        ...
        self.conv1 = nn.ConvTranspose2d(
                ...
                out_channels=512,
                kernel_size=4,      #ouput dim COCO:(4-1)*1-2*0+(4-1)+1=7
                stride=1,
                padding=0,
                bias=False)
        self.bn2d1 = nn.BatchNorm2d(512) if self.batchnorm else None
...
# or Transpose Convolutions output dim:(W−1)*S-2P+(K-1)+1 ,W = width of Input, K= Kernel Size(Square) P=Padding, S= Stride
        self.conv2 = nn.ConvTranspose2d(
                ...
                padding=0,
                bias=False)
        self.bn2d2 = nn.BatchNorm2d(256) if self.batchnorm else None
        ...
        self.conv3 = nn.ConvTranspose2d(
                ...
                padding=1,
                bias=False)
        self.bn2d3 = nn.BatchNorm2d(128) if self.batchnorm else None
        ...
        self.conv4 = nn.ConvTranspose2d(
                ...
                padding=1,
                bias=False)
        self.bn2d4 = nn.BatchNorm2d(64) if self.batchnorm else None
        ...
        self.conv5 = nn.ConvTranspose2d(
                ...
                padding=1,
                bias=False)
        self.bn2d5 = nn.BatchNorm2d(32) if self.batchnorm else None
        ...
        self.conv6 = nn.ConvTranspose2d(
                ...
                padding=1,
                bias=False)
        self.bn2d6 = nn.BatchNorm2d(16) if self.batchnorm else None
...
class Discriminator(nn.Module):
    ...
    def _init_modules(self):
        ...
        self.conv6 = nn.Conv2d(
                ...
                out_channels=1024,        
                kernel_size=4,         
                stride=1,               #ouput dim COCO:[(7−4+2*0)/1]+1 =4
                padding=0,
                bias=True)
        ...
        self.linear1 = nn.Linear(512*7*7, 1024, bias=True)
   ...
   # def forward(self, image, embed_vector):
    def forward(self, image):
        ...
        intermediate = intermediate.view((-1, 512*self.factor*self.factor))
