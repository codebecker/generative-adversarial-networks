...
class test_architectur():
    ...
    def train(self):
        ...
        generator = model_factory.generator_factory(self.ds_name, nz, self.textToImage, embed_dim).to(device)
        discriminator = model_factory.discriminator_factory(self.ds_name, self.textToImage, embed_dim).to(device)
